...
public class Camera extends JFrame implements Runnable, WebcamListener, WindowListener, UncaughtExceptionHandler, ItemListener, WebcamDiscoveryListener {
...
private Webcam webcam = null;
	...
	public void run() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					ImageIO.write(webcam.getImage(), "JPG", new File(name));
                                        String path=new File("src/main/"+name).getAbsolutePath();
		...
		webcam.addWebcamListener(Camera.this);            //
